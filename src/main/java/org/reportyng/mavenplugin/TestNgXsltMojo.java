...
public class TestNgXsltMojo extends AbstractMavenReport {
    ...
    protected void executeReport(Locale locale) throws MavenReportException {
        ...
        if (!new File(testNgResultsXml).exists()) {
            getLog().warn("File 'reportyng-results.xml' could not be found. No reports will be generated by TestNG XSLT");
            return;
        }
    ...
    private String getTestNgResultsXmlPath() {
        ...
        return testNgResultsXmlPath + File.separator + "reportyng-results.xml";
    }
